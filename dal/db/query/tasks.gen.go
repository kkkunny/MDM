...
func newTask(db *gorm.DB, opts ...gen.DOOption) task {
	...
	_task.taskDo.UseModel(&po.Task{})

	tableName := _task.taskDo.TableName()
	_task.ALL = field.NewAsterisk(tableName)
	_task.ID = field.NewString(tableName, "id")
	_task.Xlid = field.NewString(tableName, "xlid")
	_task.Qbid = field.NewString(tableName, "qbid")
	_task.UnavailableLinks = field.NewString(tableName, "unavailable_links")
	_task.AvailableLinks = field.NewString(tableName, "available_links")
...
type task struct {
	...
	Xlid             field.String
	Qbid             field.String
	UnavailableLinks field.String
	AvailableLinks   field.String
...
func (t *task) updateTableName(table string) *task {
	...
	t.Xlid = field.NewString(table, "xlid")
	t.Qbid = field.NewString(table, "qbid")
	t.UnavailableLinks = field.NewString(table, "unavailable_links")
	t.AvailableLinks = field.NewString(table, "available_links")
...
func (t *task) fillFieldMap() {
	...
	t.fieldMap["id"] = t.ID
	t.fieldMap["xlid"] = t.Xlid
	t.fieldMap["qbid"] = t.Qbid
	t.fieldMap["unavailable_links"] = t.UnavailableLinks
	t.fieldMap["available_links"] = t.AvailableLinks
}
...
type ITaskDo interface {
	...
	Unscoped() ITaskDo
	Create(values ...*po.Task) error
	CreateInBatches(values []*po.Task, batchSize int) error
	Save(values ...*po.Task) error
	First() (*po.Task, error)
	Take() (*po.Task, error)
	Last() (*po.Task, error)
	Find() ([]*po.Task, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Task, err error)
	FindInBatches(result *[]*po.Task, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*po.Task) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*po.Task, error)
	FirstOrCreate() (*po.Task, error)
	FindByPage(offset int, limit int) (result []*po.Task, count int64, err error)
...
func (t taskDo) Create(values ...*po.Task) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taskDo) CreateInBatches(values []*po.Task, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t taskDo) Save(values ...*po.Task) error {
	if len(values) == 0 {
		return nil
	}
...
func (t taskDo) First() (*po.Task, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*po.Task), nil
	}
}

func (t taskDo) Take() (*po.Task, error) {
...
func (t taskDo) Last() (*po.Task, error) {
...
func (t taskDo) Find() ([]*po.Task, error) {
	result, err := t.DO.Find()
	return result.([]*po.Task), err
}

func (t taskDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*po.Task, err error) {
	buf := make([]*po.Task, 0, batchSize)
...
func (t taskDo) FindInBatches(result *[]*po.Task, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t taskDo) FirstOrInit() (*po.Task, error) {
...
func (t taskDo) FirstOrCreate() (*po.Task, error) {
...
func (t taskDo) FindByPage(offset int, limit int) (result []*po.Task, count int64, err error) {
...
func (t taskDo) Delete(models ...*po.Task) (result gen.ResultInfo, err error) {
